...
- **space_opera** — `coyote_star` (renamed from `coyote_reach` 2026-05-01) is the Magic + Rig MVP flagship; chapter→trope wiring engaged (content PR #209)
