...
**Observability (090, 103, 124)**
- 090 OTEL Dashboard Restoration after Python Port · 103 Native OTEL via Tool Registry *(partial)* · 124 Save-Forensics Architecture — Read-Only Tiered Save Inspection, Loud-Skip Folds, and Per-Round Mechanical Census
