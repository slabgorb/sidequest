...
| **Spec: 2026-04-23 Local DM Decomposer Design** (`docs/superpowers/specs/completed/2026-04-23-local-dm-decomposer-design.md`, orchestrator) | Original LocalDM design that produced the merged consumer plumbing (DispatchPackage types, run_dispatch_bank executor, subsystems/, lethality_arbiter, redact_dispatch_package). Group A/B shipped 2026-04; Group E (live wiring) shelved 2026-04-28. |
| **Spec: 2026-04-28 LocalDM Offline-Only Design** (`docs/superpowers/specs/completed/2026-04-28-localdm-offline-only-design.md`, orchestrator) | The shelving decision. **REVERSED by ADR-113** — reversal header added 2026-05-23; the live path is restored, the offline corpus runner stays as a separate concern. |
| **ADR-113 Intent Router — Mechanical-Engagement Spine** (`docs/adr/113-intent-router-mechanical-engagement-spine.md`) | The architectural ratification of this reframe. Read alongside the source spec. Partially supersedes ADR-013 on the SDK path; amends ADR-111. |
