...
## Title
Phase 1 — Lore Cast section JSON projection (is_projectable gate, R2 portrait resolved server-side)
...
---
_Generated by `pf context create story 100-3` from the sprint YAML._
